...
| 8 | [`08_traceroute_exitoso.png`](screenshots/08_traceroute_exitoso.png) | Traceroute desde el cliente hacia PC1 mostrando el salto a través de la interfaz de túnel. |
