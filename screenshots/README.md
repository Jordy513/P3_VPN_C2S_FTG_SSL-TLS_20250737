...
| 6 | [`06_forward_traffic_accept.png`](/screenshots/06_forward_traffic_accept.png) | `Log & Report → Forward Traffic` mostrando el tráfico del cliente hacia `20.25.37.130` con acción `Accept`. |
| 7 | [`07_ping_exitoso.png`](/screenshots/07_ping_exitoso.png) | Ping exitoso desde el cliente (Linux/Windows) hacia PC1 (`20.25.37.130`) con el túnel activo. |
| 8 | [`08_traceroute_exitoso.png`](/screenshots/09_traceroute_exitoso.png) | Traceroute desde el cliente hacia PC1 mostrando el salto a través de la interfaz de túnel. |
| 9 | [`9_vpn_events_login.png`](/screenshots/9_vpn_events_login.png) | `Log & Report → VPN Events` mostrando el evento de login exitoso de `vpnuser`. |
